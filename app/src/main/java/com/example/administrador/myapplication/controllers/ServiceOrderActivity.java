...
public class ServiceOrderActivity extends AppCompatActivity {
    ...
    private CheckBox mCheckBoxPaid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            //TODO Carregar Valores nos campos...
            mEditTextClientName.setText(mServiceOrder.getClient());
            mEditTextAddress.setText(mServiceOrder.getAddress());

            final DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:SS");
            final String[] dateTimeArray = dateFormat.format(mServiceOrder.getDate()).split("[ ]");
            mEditTextDate.setText(dateTimeArray[0]);
            mEditTextTime.setText(dateTimeArray[1]);

            final DecimalFormat numberFormat = AppUtil.get(NumberFormat.getNumberInstance(Locale.US));
            numberFormat.applyPattern("#.00");
            mEditTextValue.setText(numberFormat.format(mServiceOrder.getValue()));

            mCheckBoxPaid.setChecked(mServiceOrder.isPaid());
    ...
    private void bindElements() {
        ...
        mCheckBoxPaid = AppUtil.get(this.findViewById(R.id.checkBoxPaid));
    ...
    private void saveServiceOrder() {
        ...
        if (isValid) {
            ...
            mServiceOrder.setPaid(mCheckBoxPaid.isChecked());
